...
const Sidebar = () => {
  ...
  };//how much user took time to complete the test.
  ...
  };// When the time is up the test will be automatically be sumbitted.
  ...
  //When we change the tech it will update inside the localstorage.
...
//It will halt the timer and start the timer for another test.
  ...
  }, [isTimerRunning]); //Save the timer where user left.
  ...
  //to select a particular number of question.
  ...
  const getQuestionStatus = (index) => {
    ...
    return "incorrect";
  }; //it will show you the ques that is correct, incorrect or un attempted
          ...
          <div className={sidebarStyles.sidebarHeader}>
            <div className={sidebarStyles.headerContent}>
              ...
              >
                ...
                <div>
                  <h1 className={sidebarStyles.title}>Mock Test</h1>
              ...
              <div className="flex flex-col space-y-3">
                <div className={sidebarStyles.footerTextContainer}>
                  <p className={sidebarStyles.footerText1}>
                    Master your skills one test at a time
                  </p>
              ...
              <div className={sidebarStyles.emptyStateCard}>
                <div className={sidebarStyles.emptyStateHeader}>
                  ...
                  <p className={sidebarStyles.emptyStateSubtitle}>
                    Select a technology from the sidebar to begin your test
                    journey
                  </p>
                </div>
                ...
                <div className={sidebarStyles.resultsHeader}>
                  ...
                  <div className={sidebarStyles.timeTakenContainer}>
                    ...
                    <div className={sidebarStyles.timeTakenSubtext}>
                      You completed the test in {formatElapsedTime(elapsedTime)}
                    </div>
                  </div>
                      ...
                      <ul className={sidebarStyles.instructionsList}>
                        ...
                        <li className={sidebarStyles.instructionItem}>
                          <CheckCircle
                            ...
                            className={sidebarStyles.instructionCheck}
                          />
                          Timer starts immediately when you click "Start Test"
                        </li>
                        <li className={sidebarStyles.instructionItem}>
                          <CheckCircle
                            size={14}
