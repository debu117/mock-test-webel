...
import { dashboardStyles, navbarStyles } from '../assets/dummyStyles.jsx';
...
const Dashboard = () => {
  ...
  const [timeLimit, setTimeLimit] = useState(30); //initial in mins
  ...
  const [adminStats, setAdminStats] = useState({
    totalUsers: 0,
    totalLoggedIn: 0,
    loggedInPercentage: 0,  //created in backend
  }); //states
  const { request } = useApi();

  //total users
  //all things coming from the server.js side
  useEffect(() => {
...
//total timer
  ...
  }; /* this function will open the CSV file and show
        the questions, ans, options.*/
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setToast({
        show: true,
        type: "success",
        message: `Test "${technology}" created successfully`,
      });
                        ...
                        <div className={dashboardStyles.formFields}>
                            ...
                            <div>
                                ...
                                <div className={dashboardStyles.timeHint}>
                                    ...
                                    <span> 
                                        Time allocated per candidates to complete the test 
                                    </span>
                                </div>
                                 {validationErrors.timeLimit && (
                                    <p className={dashboardStyles.errorMessage}>
                          ...
                          <div className={dashboardStyles.previewHeader}> 
                            <div> 
                                ...
                                <p className={dashboardStyles.previewSubtitle}>
                                    Review all questions before creating test
                                </p>
                            </div>
...
<div className={dashboardStyles.previewList}>
            ...
            <div className={dashboardStyles.summaryCard}>
              <h3 className={dashboardStyles.summaryTitle}>📊 Test Summary</h3>
              <div className={dashboardStyles.summaryRows}>
                <div className={dashboardStyles.summaryRow}>
                  <span className={dashboardStyles.summaryLabel}>
                    Technology:
