...
import { AlertCircle, Calendar, CheckCircle, Clock, Cpu, FileText, Filter, Plus, Search, Trash2, X, XCircle } from 'lucide-react';
const List = () => {
  ...
  // to fecth technologies coming from the server side
  useEffect(()=> {
        ...
        <div className={listPageStyles.container}>
            <div className={listPageStyles.headerWrapper}>
                <div className={listPageStyles.headerInner}>
                    <h1 className={listPageStyles.title}>Webel Mock Test</h1>
                    <p className={listPageStyles.subtitle}>
                        Create, manage and review technology with an intutive
                        responsive layout.
                    </p>
                </div>
                    ...
                    <div className={`${listPageStyles.animatedBorderBase} ${
                        ...
                        <div className={listPageStyles.inputWrapper}>
                            <div className= 'relative'>
                                <Search className={listPageStyles.searchIcon}></Search>
          ...
          {filteredTechnologies.length === 0 && (
            <div className={listPageStyles.emptyContainer}> 
                ...
                <div className={listPageStyles.emptyContent}>
                    ...
                    <Plus className={listPageStyles.emptyButtonIcon}></Plus>
