...
export const navbarStyles = {
  ...
  logoImg: "h-10 w-10 object-cover rounded",
  siteNameWrapper: "flex flex-col items-start",
  siteName: "text-lg md:text-sm xl:text-xl font-bold bg-linear-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent",
